...
public:
    ...
    /// and draw it using a assets (for example).
...
/// \li creating a assets from a 3D object rendered with OpenGL
/// \li etc.
///
/// Usage example:
///
...
///    texture.draw(assets);  // assets is a sf::Sprite
...
///
///    // Draw the texture
///    sf::Sprite assets(texture.getTexture());
///    window.draw(assets);
///
