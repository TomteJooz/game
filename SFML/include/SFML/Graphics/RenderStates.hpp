...
/// these states when they are drawn. For example, a assets
/// will set its own texture, so that you don't have to care
/// about it when drawing the assets.
///
...
/// current transform with its own transform. A assets will
/// set its texture. Etc.
///
