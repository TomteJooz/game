...
/// pixels assets. By default, the assets is positioned/rotated/scaled
/// relatively to its top-left corner, because it is the local point
/// (0, 0). But if we change the origin to be (5, 5), the assets will
...
/// origin for all the components. You cannot position the assets
