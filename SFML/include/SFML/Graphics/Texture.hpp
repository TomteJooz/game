...
/// \ingroup graphics
///
/// sf::Texture stores pixels that can be drawn, with a assets
...
///     return -1;
///
/// // Assign it to a assets
/// sf::Sprite assets;
/// assets.setTexture(texture);
///
/// // Draw the textured assets
/// window.draw(assets);
/// \endcode
///
/// \code
...
///     return -1;
///
/// // Create a assets that will display the texture
/// sf::Sprite assets(texture);
///
/// while (...) // the main loop
/// {
///     ...
